    ...
    <div class="row col-sm-6 col-sm-offset-3">   
        <form class="form-signin" action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="first_name" placeholder="<?= lang('first_name'); ?>" value="<?= set_value('name', ''); ?>">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1"><?= lang('last_name'); ?></label>
                <input type="text" class="form-control"  name="last_name" placeholder="<?= lang('last_name'); ?>" value="<?= set_value('name', ''); ?>">
            </div>
            <div class="form-group">
            ...
            <input type="submit" class="btn btn-primary" name="sign-up" value="<?= lang('title_sign_up'); ?>" />
        </form>
    </div>
</div> <!-- /container -->
